...
function scanGear() 
	...
	local HunterPetSpells = {34890, 35324, 23146, 23149, 23150, 23100, 23111, 23112, 1747, 1748, 1749, 1750, 1751, 16698, 27346, 2980, 2981, 2982, 3667, 2975, 2976, 2977, 3666, 27347, 7370, 26184, 26185, 26186, 26202, 28343, 17254, 17262, 17263, 17264, 17265, 17266, 17267, 17268, 27348, 24609, 24608, 24607, 24599, 35299, 35300, 35302, 35303, 35304, 35305, 35306, 35307, 35308, 24845, 25013, 25014, 25015, 25016, 25017, 35388, 35390, 35391, 24451, 24454, 24455, 24641, 24584, 24588, 24589, 27361, 24424, 24580, 24581, 24582, 27349, 26065, 26094, 26189, 26190, 27366, 35348}
	...
	-- Add Pet Spells
	if (pclass == "hunter") then
		for _,k in pairs(HunterPetSpells) do
